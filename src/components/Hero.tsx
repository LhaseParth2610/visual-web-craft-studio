  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 flex flex-col items-center text-center px-4 gap-6">
        <span className="px-4 py-2 bg-primary/10 dark:bg-primary/20 rounded-full text-sm font-medium text-primary animate-fade-in flex items-center gap-2 shadow-sm">
        ...
        <div className="space-y-6 animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight md:leading-tight lg:leading-tight max-w-4xl">
            Hello, I'm <span className="gradient-text">Parth Lhase</span>
          </h1>
          
          <div className="h-12 md:h-16 flex items-center justify-center">
            <p className="typewriter inline-block font-mono text-lg md:text-2xl text-primary border-r-2 border-primary py-1">
              Coding minds, shaping mine
            </p>
          </div>
        </div>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mt-4 animate-fade-in font-mono bg-slate-800/20 dark:bg-slate-900/40 p-4 rounded-lg shadow-inner">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8 animate-fade-in">
          ...
          <Button size="lg" variant="outline" className="rounded-full text-base px-8 font-mono shadow-sm hover:shadow-md transition-all">
        ...
        <div className="flex gap-4 mt-4">
          <a href="https://github.com/LhaseParth2610" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition bg-slate-800/20 dark:bg-slate-900/40 p-2 rounded-full">
            <Github className="h-6 w-6 text-foreground hover:text-primary" />
          </a>
          <a href="https://linkedin.com/in/parth-lhase-60342a330" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition bg-slate-800/20 dark:bg-slate-900/40 p-2 rounded-full">
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-center animate-float">
        <a href="#about" aria-label="Scroll down" className="bg-slate-800/20 dark:bg-slate-900/40 p-2 rounded-full hover:bg-primary/20 transition-all">
